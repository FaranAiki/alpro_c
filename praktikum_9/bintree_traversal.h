...
/* I.S. p terdefinisi
   F.S. Elemen (key) ditampilkan sesuai urutan preorder, dipisah spasi (menyisakan spasi di akhir), TANPA ENDLINE */

void printInOrder(BinTree p);
/* Menampilkan elemen (key) inorder: kiri, akar, kanan, dipisah spasi (menyisakan spasi di akhir), TANPA ENDLINE */

void printPostOrder(BinTree p);
/* Menampilkan elemen (key) postorder: kiri, kanan, akar, dipisah spasi (menyisakan spasi di akhir), TANPA ENDLINE */
...
/* I.S. l mungkin kosong atau tidak
   F.S. Seluruh elemen list (key) ditampilkan dalam format linked list eksplisit
